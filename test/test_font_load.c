...
void test_segoe_ui_font_load( void )
{
	...
	it_i("Load segoeui.ttf", LCUIFont_LoadFile( "C:/windows/fonts/segoeui.ttf" ), 0 );
	it_i("Load segoeuib.ttf", LCUIFont_LoadFile( "C:/windows/fonts/segoeuib.ttf" ), 0 );
	it_i("Load segoeuii.ttf", LCUIFont_LoadFile( "C:/windows/fonts/segoeuii.ttf" ), 0 );
	it_i("Load segoeuil.ttf", LCUIFont_LoadFile( "C:/windows/fonts/segoeuil.ttf" ), 0 );
	it_i("Load segoeuisl.ttf", LCUIFont_LoadFile( "C:/windows/fonts/segoeuisl.ttf" ), 0 );
	it_i("Load segoeuiz.ttf", LCUIFont_LoadFile( "C:/windows/fonts/segoeuiz.ttf" ), 0 );
	it_i("Load seguibl.ttf",  LCUIFont_LoadFile( "C:/windows/fonts/seguibl.ttf" ), 0 );
	it_i("Load seguili.ttf", LCUIFont_LoadFile( "C:/windows/fonts/seguili.ttf" ), 0 );
...
void test_arial_font_load( void )
{
	...
	it_i( "Load arialbi.ttf", LCUIFont_LoadFile( "C:/windows/fonts/arialbi.ttf" ),0 );
	it_i( "Load ariali.ttf", LCUIFont_LoadFile( "C:/windows/fonts/ariali.ttf" ), 0 );
	it_b("check get font (style: normal, weight: normal)",
...
void test_font_load( void )
{
	...
	/* 测试是否能够从字体文件中载入字体 */
	it_i("Check LCUIFont_LoadFile success", LCUIFont_LoadFile( "test_font_load.ttf" ), 0);
	...
	it_i("Check LCUIFont_LoadCSSFile success", LCUI_LoadCSSFile( "test_font_load.css" ), 0 );
	it_b("Check LCUIFont_GetId success", LCUIFont_GetId( "icomoon", 0, 0 ) > 0, TRUE );
	LCUI_FreeCSSParser();
	LCUI_FreeCSSLibrary();
	LCUI_FreeFontLibrary();
}
