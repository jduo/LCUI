...
static void test_string_object(void)
{
	...
	it_i("Check string object concatenation", Object_Compare(&str3, tmp), 0);
	it_b("Check string object append stores result in correct object", Object_Operate(str1, "+=", str2) == str1, TRUE);
	it_i("Check string object append has correct result", Object_Compare(str1, &str3), 0);
	it_s("Check raw string from string object", str1->value.string, "helloworld");
...
static void test_wstring_object(void)
{
	...
	it_s("Check convert wstring object to raw string", str4->value.string, "1000");
...
static void test_number_object(void)
{
	...
	it_b("Check number object *= stores result in left object", Object_Operate(&num1, "*=", &num2) == &num1, TRUE);
	it_i("Check result of number object *=", Object_Compare(&num1, tmp), 0);
	it_b("Check raw value of number object", tmp->value.number == 5.0,TRUE);
	...
	it_s("Check result of converting number object to string", str->value.string, "5");
