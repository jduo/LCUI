...
static void check_textview_set_text(void)
{
	...
	it_b("Check inline block width", self.inline_block->width > 520.0f, TRUE);
	it_b("Check inline block height", self.inline_block->height < 45.0f, TRUE);
}
...
static void check_textview_set_short_content_css(void)
{
	...
	it_b("Check inline block width", self.inline_block->width < 70.0f, TRUE);
	it_b("Check inline block height", self.inline_block->height < 45.0f, TRUE);
}
...
static int check_textview_set_long_content_css(void)
{
	...
	it_b("Check inline block width", self.inline_block->width > 250.0f, TRUE);
	it_b("Check inline block height", self.inline_block->height < 45.0f, TRUE);
}
...
void test_textview_resize(void)
{
	...
	describe("check textview set short content css", check_textview_set_short_content_css);
	test_textview_set_long_content_css(NULL);
	describe("check textview set long content css", check_textview_set_long_content_css);
